                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/selo_tecnologia_colorido_130x131.png',
                        width: double.infinity,
                        height: 123.0,
                        fit: BoxFit.contain,
                      ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Alessandra de Carvalho Silva (Editoria)\nMarcelo Perrone Ricalde (Atualizações)',
                      textAlign: TextAlign.center,
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 0.0),
                    child: Text(
                      'Hugo Rogerio Borges de Freitas\nMarcelo Perrone Ricalde',
                      textAlign: TextAlign.center,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.readexPro(
                              fontWeight: FlutterFlowTheme.of(context)
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 0.0),
                    child: Text(
                      'Maria Christine Saraiva Barbosa',
                      textAlign: TextAlign.center,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.readexPro(
                              fontWeight: FlutterFlowTheme.of(context)
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 0.0),
                    child: Text(
                      'Gallo, D.; Nakano, O.; Silveira Neto, S.; Carvalho, R. P. L.; Baptista, G. C.; Berti Filho, E.; Parra, J. R. P.; Zucchi, R. A.; Alves, S. B.; Vendramim, J. D.; Marchini, L. C.; Lopes, J. R. S.; Omoto, C. Entomologia Agrícola. Piracicaba: Fealq, 2002. 920p.\n\nMahr, D. L.; Ridgway, N. M. Biological control of insects and mites: an introduction to beneficial natural enemies and their use in pest management. Madison: North Central Regional Publication, 1993. 92p.\n\nParra, J. R. P.; Botelho, P. S. M.; Corrêa-Ferreira, B. S.; Bento, J. M. S. Controle Biológico no Brasil – parasitoides e predadores. São Paulo: Manole, 2002. 635 p.\n\nVenzon, M.; Amaral, D. S. S. L.; Perez, A. L.; Cruz, F. A. R.; Togni, P. H. B; Oliveira, R. M. Identificação e manejo ecológico de pragas da cultura da pimenta. Viçosa: Unidade Regional EPAMIG Zona da Mata, 2011. 40 p.\n\nVenzon, M.; Paula Jr., T. J. Controle biológico de pragas, doenças e plantas invasoras. Informe Agropecuário, v. 30, n. 251, jul/ago, 2009. 124 p.\n',
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        await launchURL('https://www.embrapa.br/agrobiologia');
                      },
                      child: Text(
                        'Site: www.embrapa.br/agrobiologia',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.readexPro(
                                fontWeight: FlutterFlowTheme.of(context)
                                    .bodyMedium
